...
const CARD_POOL = [
  { id: 1, name: "Giant", type: "troop", elixir: 5, rarity: "rare", hp: 3400, dmg: 200, speed: "medium", attackRange: 1.5 * TILE_SIZE, description: "High HP, specializes in construction", movementType: "ground", targetType: "buildings", splashRadius: 0 },
  { id: 2, name: "Royal Giant", type: "troop", elixir: 6, rarity: "common", hp: 2500, dmg: 150, speed: "slow", attackRange: 6.5 * TILE_SIZE, description: "Ranged tank, direct fire tower", movementType: "ground", targetType: "buildings", splashRadius: 0 },
  { id: 3, name: " Mini P.E.K.K.A", type: "troop", elixir: 4, rarity: "rare", hp: 1100, dmg: 600, speed: "fast", attackRange: 1.2 * TILE_SIZE, description: "High single target damage", movementType: "ground", targetType: "any", splashRadius: 0 },
  { id: 4, name: " Skeleton Army", type: "troop", elixir: 3, rarity: "epic", hp: 0, dmg: 0, speed: "medium", attackRange: 0, description: "Lots of 1-cost Skeleton Swarms", movementType: "ground", targetType: "any", spawnCount: 15, spawnUnitId: "skeleton_basic", splashRadius: 0 }, // hp/dmg 0 as it's a spawner
  { id: 5, name: " Prince", type: "troop", elixir: 5, rarity: "epic", hp: 1500, dmg: 350, speed: "medium", attackRange: 1.6 * TILE_SIZE, description: "Charged dash doubles damage", movementType: "ground", targetType: "any", splashRadius: 0, special: "charge" },
  { id: 6, name: " Baby Dragon", type: "troop", elixir: 4, rarity: "epic", hp: 1000, dmg: 130, speed: "medium", attackRange: 3.5 * TILE_SIZE, description: "Aerial Range Damage", movementType: "air", targetType: "any", splashRadius: 1.5 * TILE_SIZE },
  { id: 7, name: " Valkyrie", type: "troop", elixir: 4, rarity: "rare", hp: 1600, dmg: 220, speed: "medium", attackRange: 1.2 * TILE_SIZE, description: "360°  AOE", movementType: "ground", targetType: "ground", splashRadius: 1.2 * TILE_SIZE, special: "spin_attack" },
  { id: 8, name: " Fireball", type: "spell", elixir: 4, rarity: "rare", hp: 0, dmg: 570, speed: "n/a", attackRange: 2.5 * TILE_SIZE, description: "Medium-cost area spell", movementType: "n/a", targetType: "any", splashRadius: 2.5 * TILE_SIZE },
  { id: 9, name: " The Log", type: "spell", elixir: 2, rarity: "legendary", hp: 0, dmg: 240, speed: "n/a", attackRange: 10 * TILE_SIZE, description: "Straight line rolling", movementType: "n/a", targetType: "ground", splashRadius: 3.0 * TILE_SIZE, special: "linear_pushback" }, // attackRange here is length
  { id: 10, name: " Arrows", type: "spell", elixir: 3, rarity: "common", hp: 0, dmg: 240, speed: "n/a", attackRange: 4 * TILE_SIZE, description: "Large-scale group injuries", movementType: "n/a", targetType: "any", splashRadius: 4 * TILE_SIZE },
  { id: 11, name: " Lightning", type: "spell", elixir: 6, rarity: "epic", hp: 0, dmg: 860, speed: "n/a", attackRange: 3.5 * TILE_SIZE, description: "Choose 3 targets with high damage", movementType: "n/a", targetType: "any", splashRadius: 0, special: "multi_target_3" }, // attackRange is selection radius
  { id: 12, name: " Inferno Tower", type: "building", elixir: 5, rarity: "rare", hp: 1500, dmg: 50, speed: "n/a", attackRange: 6 * TILE_SIZE, description: "Incremental Damage Tank Killer", movementType: "n/a", targetType: "any", splashRadius: 0, special: "ramping_damage" },
  { id: 13, name: " Cannon", type: "building", elixir: 3, rarity: "common", hp: 800, dmg: 130, speed: "n/a", attackRange: 5.5 * TILE_SIZE, description: "Low-cost anti-tank building", movementType: "n/a", targetType: "ground", splashRadius: 0 },
  { id: 14, name: " Tesla", type: "building", elixir: 4, rarity: "common", hp: 1000, dmg: 190, speed: "n/a", attackRange: 5.5 * TILE_SIZE, description: "Submarine Anti-Air Land", movementType: "n/a", targetType: "any", splashRadius: 0, special: "hide_until_attack" },
  { id: 15, name: " Graveyard", type: "spell", elixir: 5, rarity: "legendary", hp: 0, dmg: 0, speed: "n/a", attackRange: 3.5 * TILE_SIZE, description: "Randomly spawn skeletons on enemy towers", movementType: "n/a", targetType: "ground", spawnCount: 1, spawnUnitId: "skeleton_basic", special: "area_spawn_over_time" }, // attackRange is spell radius
  { id: 16, name: " Freeze", type: "spell", elixir: 4, rarity: "epic", hp: 0, dmg: 100, speed: "n/a", attackRange: 3 * TILE_SIZE, description: "Immobilizes and damages", movementType: "n/a", targetType: "any", splashRadius: 3 * TILE_SIZE, special: "freeze" },
  { id: 17, name: " Witch", type: "troop", elixir: 5, rarity: "epic", hp: 700, dmg: 110, speed: "medium", attackRange: 5 * TILE_SIZE, description: "Summon Skeleton + AOE", movementType: "ground", targetType: "any", splashRadius: 0.5 * TILE_SIZE, special: "spawn_skeletons_periodically" },
  { id: 18, name: " Archers", type: "troop", elixir: 3, rarity: "common", hp: 250, dmg: 90, speed: "medium", attackRange: 5 * TILE_SIZE, description: "Dual ranged light units", movementType: "ground", targetType: "any", spawnCount: 2, spawnUnitId: "archer_single", splashRadius: 0 }, // spawn 2 archers
  { id: 19, name: " Knight", type: "troop", elixir: 3, rarity: "common", hp: 1400, dmg: 160, speed: "medium", attackRange: 1.2 * TILE_SIZE, description: "Medium-cost balanced tank", movementType: "ground", targetType: "any", splashRadius: 0 },
  { id: 20, name: " Bandit", type: "troop", elixir: 3, rarity: "legendary", hp: 750, dmg: 160, speed: "fast", attackRange: 0.8 * TILE_SIZE, description: "66", movementType: "ground", targetType: "ground", splashRadius: 0, special: "dash_attack" }, // attackRange is melee, dash range is separate
  { id: 21, name: " Electro Wizard", type: "troop", elixir: 4, rarity: "legendary", hp: 600, dmg: 100, speed: "fast", attackRange: 5 * TILE_SIZE, description: "Reduce attack speed and stun", movementType: "ground", targetType: "any", splashRadius: 0, special: "stun_split_attack" }, // Hits 2 targets
  { id: 22, name: " Spirit", type: "troop", elixir: 1, rarity: "common", hp: 190, dmg: 150, speed: "very fast", attackRange: 2.5 * TILE_SIZE, description: "Consumption cycle", movementType: "ground", targetType: "any", splashRadius: 1.5 * TILE_SIZE, special: "kamikaze" }, // Usually kamikaze
  { id: 23, name: " Cannon Cart", type: "troop", elixir: 5, rarity: "epic", hp: 700, dmg: 200, speed: "medium", attackRange: 5.5 * TILE_SIZE, description: "After breaking the shield, it becomes a building", movementType: "ground", targetType: "ground", splashRadius: 0, special: "shield_to_building" }, // HP is shield, then becomes building
  { id: 24, name: " X-Bow", type: "building", elixir: 6, rarity: "epic", hp: 1300, dmg: 40, speed: "n/a", attackRange: 11.5 * TILE_SIZE, description: "Long range firepower", movementType: "n/a", targetType: "ground", splashRadius: 0, special: "fast_attack_rate" },
  { id: 25, name: " Balloon", type: "troop", elixir: 5, rarity: "epic", hp: 1300, dmg: 700, speed: "medium", attackRange: 1.2 * TILE_SIZE, description: "Empty tank, death explosion", movementType: "air", targetType: "buildings", splashRadius: 0, special: "death_damage" }, // attackRange is melee, death_damage has radius
  { id: 26, name: " Queen", type: "troop", elixir: 5, rarity: "legendary", hp: 1000, dmg: 200, speed: "medium", attackRange: 5 * TILE_SIZE, description: "Stealth Skills", movementType: "ground", targetType: "any", splashRadius: 0, special: "invisibility_skill" }, // Archer Queen inspired
  { id: 27, name: " Mirror", type: "spell", elixir: "+1", rarity: "epic", hp: 0, dmg: 0, speed: "n/a", attackRange: 0, description: "Repeat previous", movementType: "n/a", targetType: "n/a", special: "mirror_last_card" },
  { id: 28, name: " Guards", type: "troop", elixir: 3, rarity: "epic", hp: 80, dmg: 80, speed: "fast", attackRange: 1.2 * TILE_SIZE, description: "Shield Skull", movementType: "ground", targetType: "any", spawnCount: 3, spawnUnitId: "guard_skeleton", splashRadius: 0 }, // HP is shield HP, then unit HP
  { id: 29, name: " Golden Knight", type: "troop", elixir: 4, rarity: "legendary", hp: 1200, dmg: 180, speed: "medium", attackRange: 1.2 * TILE_SIZE, description: "", movementType: "ground", targetType: "ground", splashRadius: 0, special: "chain_dash" },
  { id: 30, name: " Miner", type: "troop", elixir: 3, rarity: "legendary", hp: 1000, dmg: 130, speed: "fast", attackRange: 1.2 * TILE_SIZE, description: "Generates any underground", movementType: "ground", targetType: "any", splashRadius: 0, special: "deploy_anywhere_ground" },
]; 
...
function renderMainMenu() {
  ...
  textSize(64);
  textAlign(CENTER, CENTER);
  text("Card battle game(Clash Royale)", CANVAS_WIDTH / 2, CANVAS_HEIGHT / 3);
...
class DeckBuilder {
  constructor(cardPool) {
    ...
    this.confirmButton = { x: CANVAS_WIDTH - 150, y: CANVAS_HEIGHT - 80, w: 200, h: 60, text: "Confirm the deck" };
  }
...
function drawCardInfoBox(card) {
  ...
  infoLines.push(`Holy Water: ${card.elixir === "+1" ? "Copy the previous card +1 fee" : card.elixir}`); // 特殊處理鏡像聖水
